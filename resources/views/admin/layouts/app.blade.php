            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        <li class="  has-sub">
                            <a class="js-arrow text-decoration-none @if(url()->current() == route('categoryadmin'))
                                active
                            @endif" href="{{  route('categoryadmin') }}">
                    ...
                    <ul class="list-unstyled navbar__list">
                        <li class="  has-sub">
                            <a  href="{{ route('productname') }}" class="js-arrow text-decoration-none @if (url()->current() == route('productname'))
                                active
                            @endif">
                    ...
                    <ul class="list-unstyled navbar__list">
                        <li class="  has-sub">
                            <a class="js-arrow text-decoration-none @if (url()->current() == route('orderuilistss'))
                                active
                            @endif" href="{{ route('orderuilistss') }}">
                    ...
                    <ul class="list-unstyled navbar__list">
                        <li class="  has-sub">
                            <a class="js-arrow text-decoration-none" href="{{ route('go_to_admin_contact_ui') }}">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            ...
                                            <img src="{{ asset('usergirl/girl.jfif') }}" alt="">
                                            @else
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__body">
                                                <div class="account-dropdown__item">
                                                    <a href="{{ route('adminui_to') }}">
                                                        <i class="fa-solid fa-users-gear"></i>Admin List </a>
                                                </div>
                                            </div>
                                            <div class="account-dropdown__body">
                                                <div class="account-dropdown__item">
                                                    <a href="{{  route('gotouserlistui') }}">
